...
def parent_hub(rows: list[dict[str, str]]) -> None:
    ...
    category_meta = {
        ...
        "초4영어학원": "초4 영어 어휘·문장 구조·독해 근거 안내",
        "초5수학학원": "초5 수학 분수·소수·도형·문장제 안내",
        "초5영어학원": "초5 영어 어휘 확장·문장 구조·독해 근거 안내",
        "초6수학학원": "초6 수학 분수·소수 연산·비와 비율·문제 해결 안내",
        "초6영어학원": "초6 영어 어휘·문법 연결·독해·짧은 쓰기 안내",
    }
